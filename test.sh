...
#Apprentissage SPECIAL
#./main --buildDatabase -lexicons data/corpus/corrige/lexique data/corpus/corrige/vocabulaireSpecial data/corpus/corrige/germinal.txt data/corpus/corrige/bizet.txt -corpora data/corpus/corrige/testCorrige.txt data/corpus/corrige/trainCorrige.txt -pairs data/corpus/brut/trainBrut.txt data/corpus/corrige/trainCorrige.txt data/corpus/brut/testBrut.txt data/corpus/corrige/testCorrige.txt data/corpus/brut/tableTradCustom data/corpus/corrige/tableTradCustom
