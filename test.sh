...
#./main --buildDatabase -lexicons data/corpus/corrige/lexique data/corpus/corrige/vocabulaireSpecial data/corpus/corrige/germinal.txt -corpora data/corpus/corrige/germinal.txt data/corpus/brut/corpus_bigchat.txt -pairs data/corpus/brut/trainBrut.txt data/corpus/corrige/trainCorrige.txt data/corpus/brut/testBrut.txt data/corpus/corrige/testCorrige.txt data/corpus/brut/tableTradCustom data/corpus/corrige/tableTradCustom
