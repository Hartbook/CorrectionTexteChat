...
./main --buildDatabase -lexicons data/corpus/corrige/lexiqueBackup data/corpus/corrige/vocabulaireSpecial -corpora data/corpus/brut/corpus_bigchat.txt -pairs data/corpus/brut/trainBrut.txt data/corpus/corrige/trainCorrige.txt data/corpus/brut/tableTradCustom data/corpus/corrige/tableTradCustom
